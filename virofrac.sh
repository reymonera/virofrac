...
if [[ $# -eq 0 ]]; then
    ...
    echo ' @@---@------@---@@'
    echo ' @#-=@--------@=-#@'
    echo ' @#@+@@@@@@@@@@+@#@    Yb    dP 88 88""Yb  dP"Yb  888888 88""Yb    db     dP""b8'
    echo ' @#**@========@**#@     Yb  dP  88 88__dP dP   Yb 88__   88__dP   dPYb   dP   `"'
    echo ' @@---@======@---@@      YbdP   88 88"Yb  Yb   dP 88""   88"Yb   dP__Yb  Yb'
    echo ' @@----#====#----@@       YP    88 88  Yb  YbodP  88     88  Yb dP""""Yb  YboodP'
    echo '   @@---%==%---@@'
    echo '%**   @++@@++@  ***%                                   _     _  '
    echo '*****#* #**# *#*****                             /|   / \   / \ '
    echo '%******#****#******%                       \/ o   | o \_/ o \_/ '
